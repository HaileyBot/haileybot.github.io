...
class Ajax_pagination{
	...
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="">';
	var $full_tag_close		= '</div>';
	var $first_tag_open		= '';
	var $first_tag_close	= '&nbsp;';
	var $last_tag_open		= '&nbsp;';
	var $last_tag_close		= '';
	var $cur_tag_open		= '<a class="btn active btn-info">';
	var $cur_tag_close		= '</a>';
	var $next_tag_open		= '&nbsp;';
	var $next_tag_close		= '&nbsp;';
	var $prev_tag_open		= '&nbsp;';
   ...
   var $show_count      = true;
	...
	function getAJAXlink( $count, $text) {
        ...
        if( $this->div == '')
            return '<a class="btn btn-default" href="'. $this->anchor_class . ' ' . $this->base_url . $count . '">'. $text .'</a>';
            
        $pageCount = $count?$count:0;
        $this->additional_param = "{'page' : $pageCount}";

		return "<a class='btn btn-default' href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
